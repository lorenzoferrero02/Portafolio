...
const links: SocialLink[] = [
  {
    href: 'mailto:lorenzo.ferrero2002@gmail.com',
    label: 'Email',
    icon: <MailIcon />,
  },
  {
    href: 'https://instagram.com/lorenzoferreroo',
    label: 'Instagram',
    icon: <InstagramIcon />,
  },
  {
    href: 'https://github.com/lorenzoferrero02',
    label: 'GitHub',
    icon: <GitHubIcon />,
  },
];
